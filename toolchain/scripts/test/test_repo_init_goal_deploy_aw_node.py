...
def test_node_deploy_servo_generates_weak_doc_temporary_understanding_when_requested(
    ...
    assert "milestone_blocking_decision: block_create, block_upsert, block_activate, block_derive_worktrack" in complex_gate
...
def test_repo_init_goal_payload_descriptors_use_node_helper() -> None:
