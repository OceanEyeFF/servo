...
**[docs/servo-installer/README.md](../../servo-installer/README.md)** — servo-installer 文档章节索引。
...
| `deploy/skill-deployment-maintenance.md` | [`servo-installer/runbooks/`](../../servo-installer/runbooks/skill-deployment-maintenance.md) |
| `deploy/uninstall-remove-runbook.md` | [`servo-installer/runbooks/`](../../servo-installer/runbooks/uninstall-remove-runbook.md) |
| `deploy/managed-files-ownership.md` | [`servo-installer/reference/`](../../servo-installer/reference/managed-files-ownership.md) |
| `deploy/existing-code-adoption.md` | [`servo-installer/reference/`](../../servo-installer/reference/existing-code-adoption.md) |

## 保留内容

本目录不再承担 servo-installer operator 文档。与 servo-installer 无关的项目维护内容保留在 `docs/project-maintenance/` 其他位置。
