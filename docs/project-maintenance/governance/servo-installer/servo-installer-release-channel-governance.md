...
- GitHub Release `v0.7.0-rc.2` 已发布为 prerelease，target commit `cbde0df5a84074baeddba8e773b47379f5efaa1c`；npm `servo-installer@0.7.0-rc.2` 的 `gitHead` 同为 `cbde0df5a84074baeddba8e773b47379f5efaa1c`
