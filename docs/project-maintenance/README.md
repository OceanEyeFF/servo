...
`project-maintenance/` 不长期承载 `suspended` 文档；暂停中的共享 runbook 转为 `superseded`，非共享草稿移出。
...
- 安装 skill：[deploy/deploy-runbook.md](../servo-installer/runbooks/deploy-runbook.md)
- 已有 mounts 想更新或复验：[deploy/skill-deployment-maintenance.md](../servo-installer/runbooks/skill-deployment-maintenance.md)
