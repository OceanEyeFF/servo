...
19. [harness/artifact/worktrack/plan-task-queue.md](./harness/artifact/worktrack/plan-task-queue.md)
20. [harness/artifact/worktrack/dispatch-packet.md](./harness/artifact/worktrack/dispatch-packet.md)
21. [harness/artifact/worktrack/gate-evidence.md](./harness/artifact/worktrack/gate-evidence.md)
22. [harness/artifact/worktrack/debug-evidence.md](./harness/artifact/worktrack/debug-evidence.md)
23. [harness/artifact/control/README.md](./harness/artifact/control/README.md)
24. [harness/artifact/control/control-state.md](./harness/artifact/control/control-state.md)
25. [harness/artifact/control/milestone.md](./harness/artifact/control/milestone.md)
26. [harness/artifact/control/milestone-gate-aggregation.md](./harness/artifact/control/milestone-gate-aggregation.md)
27. [harness/artifact/control/composite-milestone-acceptance.md](./harness/artifact/control/composite-milestone-acceptance.md)
28. [harness/artifact/control/append-request.md](./harness/artifact/control/append-request.md)
29. [harness/artifact/control/goal-change-request.md](./harness/artifact/control/goal-change-request.md)
30. [harness/artifact/control/node-type-registry.md](./harness/artifact/control/node-type-registry.md)
