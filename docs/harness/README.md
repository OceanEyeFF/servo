...
`docs/harness/` 是当前仓库的 Harness-first 文档主线，承接 Harness doctrine、runtime protocol、scope、跨模块 artifact contracts 与 workflow family policy。Canonical package inventory 由 `product/harness/skills/README.md` 承接。
...
| 实现映射层 | [catalog/README.md](./catalog/README.md) | 保留 Supervisor、Repo 与 Milestone 的 docs-to-source 映射；Worktrack package inventory 见 [product skills README](../../product/harness/skills/README.md) |
...
| `catalog/` | 查 Supervisor、Repo 与 Milestone 的文档映射；不作为 Worktrack Skill 运行前置 |
...
| Canonical Skill package inventory | [product/harness/skills/README.md](../../product/harness/skills/README.md) |
