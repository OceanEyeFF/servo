...
- scanner_command: PYTHONDONTWRITEBYTECODE=1 python3 .agents/skills/repo-init-goal-skill/scripts/complexity_signal_scanner.py --repo <repo> --json
  - scanner_command_alternatives: PYTHONDONTWRITEBYTECODE=1 python3 .claude/skills/repo-init-goal-skill/scripts/complexity_signal_scanner.py --repo <repo> --json
